...
- :hammer_and_wrench: I (used to) specialize in:  `SQL` `Python` `Tableau` `Excel` `Power Bi` `R` ... Now moving to Cyber
...
### Working on 🏃 
🔄 Learning more about: GRC, Forensics, AWS, OSING, Red Team, RITA ...
